INSERT INTO public.users (
    id, address, email, first_name, ignored_notifications, status, last_name, password, phone_number, role
      ...
      (11, '285 Lafayette St.', 'super.admin@example.com', 'David', ARRAY[]::smallint[], 1, 'Bowler', '$2a$10$Rc/FzMCDUkLkCPsFUSR/OOzN9GM9kl6dugIm6zZuhYhTGfrPeO2Um', '+3815552479', 4)
...
INSERT INTO public.super_admin (id) VALUES
    (11)
    ON CONFLICT (id) DO NOTHING;
