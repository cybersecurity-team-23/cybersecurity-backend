...
@TableGenerator(name="reservation_id_generator", table="primary_keys", pkColumnName="key_pk", pkColumnValue="reservation", initialValue = 25, valueColumnName="value_pk")
